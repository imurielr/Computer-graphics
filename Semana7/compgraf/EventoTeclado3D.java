...
public class EventoTeclado3D extends JPanel implements KeyListener {
    Graphics2D g2d;
    int w, h;
    Point3[] puntos3D;   // Puntos del objeto
    Edge2[] bordes3D;    // Bordes del objeto
    ...
    String archivo =  "/Users/isamuriel/Documents/Proyectos Computacion grafica/Semana7/compgraf/barco.txt";
